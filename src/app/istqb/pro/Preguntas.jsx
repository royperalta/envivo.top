...
export default function Pregunta(props) {
    ...
    useEffect(() => {
        setAnswers({});
    }, [datos]); // Esto se ejecutará cuando cambien los datos
    ...
    return (
        <div>
            ...
            <div className='fixed bottom-0 left-0 right-0 bg-[#45495f] text-white p-1 rounded flex items-center justify-center gap-2'>
                <div>Resultado: </div>
                <div className='rounded-md p-2 bg-[#23242e] flex items-center flex-items gap-2'>
                    <div>Correcto: </div>
