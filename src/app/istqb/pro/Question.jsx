            ...
            <div>
                ...
                <div className='px-10 '>
                    {questionData.opciones.map((opcion, index) => (
                        <div key={index}
                            className={`flex items-center hover:bg-[#ededf1] hover:text-black rounded p-1 cursor-pointer ${answerClassName(opcion.letra)} text-sm mb-2 transition-colors duration-300`}
